...
public class MailUtil {
    ...
    public static String myEmailPassword = "7113148759zyc";
    ...
    public static void sendMail() throws MessagingException, IOException{
        ...
        // 使用properties对象加载输入流
        properties.load(in);
        properties.getProperty("myEmailAccount");
    	Properties props = new Properties();                    // 参数配置
        props.setProperty("mail.transport.protocol", "smtp");   // 使用的协议（JavaMail规范要求）
        props.setProperty("mail.smtp.host", properties.getProperty("myEmailSMTPHost"));   // 发件人的邮箱的 SMTP 服务器地址
